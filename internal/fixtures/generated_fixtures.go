...
//go:generate mockgen -destination franchises_model_mock.go  -package fixtures -mock_names FranchiseModel=FranchiseModelMock github.com/asankov/gira/cmd/api/server FranchiseModel
